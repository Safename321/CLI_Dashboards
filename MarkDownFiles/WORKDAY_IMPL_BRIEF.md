...
1. **Patch the design docs to v2.0.0 reality** per `00-RELEVANCE-AUDIT.md`: fix every item in `01-architecture.md`, `04-staging-plan.md`, `CODEBASE_FILES_READ.md`, `OPEN_QUESTIONS.md` (#18 is answered: docs live in `WorkDay/`). Mark Phase-0 items already done.
